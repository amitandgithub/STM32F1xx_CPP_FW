...
{        
    ...
    while(1)
    {
        ...
        case 7:    
            ...
            reg = 4;
            Intr_TxRx[0] = reg;
            I2CDevIntr.MasterTxRx(0x80,&Intr_TxRx[0],1,&Intr_TxRx[5],2,1);
            while(I2CDevIntr.GetState() != HAL::I2CIntr::READY);
            curr = ((Intr_TxRx[5] << 8) | Intr_TxRx[6]);
            Current = curr;  
            Current = Current/10;
        ...
        case 8:    
            ...
            reg = 2;
            Intr_TxRx[0] = reg;
            I2CDevIntr.MasterTxRx(0x80,&Intr_TxRx[0],1,&Intr_TxRx[5],2,0);
            while(I2CDevIntr.GetState() != HAL::I2CIntr::READY);
            curr = ((Intr_TxRx[5] << 8) | Intr_TxRx[6]);
            Voltage = (int16_t)((curr >> 3) * 4);
            Voltage = Voltage * 0.001;
        ...
        case 9:  
            ...
            Intr_TxRx[2] = 'I';
            Intr_TxRx[3] = 'T';
            I2CDevIntr.MasterTxRx(slaveaddress,&Intr_TxRx[0],4,&Intr_TxRx[5],6,1); 
            while(I2CDevIntr.GetState() != HAL::I2CIntr::READY);
            testID = 8;
            break; 
        case 10:  
            ...
            Intr_TxRx[2] = 'I';
            Intr_TxRx[3] = 'T';
            I2CDevIntr.MasterTxRx(slaveaddress,&Intr_TxRx[0],4,&Intr_TxRx[5],2,0); 
            while(I2CDevIntr.GetState() != HAL::I2CIntr::READY);
            break;  
