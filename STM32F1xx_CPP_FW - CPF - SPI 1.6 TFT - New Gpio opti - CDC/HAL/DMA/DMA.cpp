...
//                        DMAConfig->Priority);
    ...
    DMA::DMAStatus_t DMA:: Load(uint32_t Channel, uint32_t PeripheralAddress, uint32_t MemoryAddress, uint32_t DataLength, uint32_t DataDirection,uint32_t width)
    {
      uint32_t i = LL_DMA_MDATAALIGN_HALFWORD; // 1024, 0x400
      i = LL_DMA_MDATAALIGN_WORD; //  0x800
      i = LL_DMA_PDATAALIGN_HALFWORD; // 1024, 0x100
      i = LL_DMA_PDATAALIGN_WORD; //  0x200
