...
char Text4[20] = "Sumit             ";       
uint32_t Delay4;                             
const HMI::WindowContext_t  WindowContext4   = {0,127,CURRENT_FONT_H*Line1,CURRENT_FONT_H*Line2,&CURRENT_FONT,GREEN,BLACK,RED};
const HMI::SettingContext_t SettingContext4  = {&Delay4,Text4,&aSettingCallback,14,3,6};
                                             
char Text5[20] = "Avni              ";       
uint32_t Delay5;                             
const HMI::WindowContext_t  WindowContext5   = {0,127,CURRENT_FONT_H*Line2,CURRENT_FONT_H*Line3,&CURRENT_FONT,GREEN,BLACK,RED};
const HMI::SettingContext_t SettingContext5  = {&Delay5,Text5,&aSettingCallback,14,3,5};

char Text6[20] = "Vani              ";
uint32_t Delay6;
const HMI::WindowContext_t  WindowContext6   = {0,127,CURRENT_FONT_H*Line3,CURRENT_FONT_H*Line4,&CURRENT_FONT,GREEN,BLACK,RED};
...
const HMI::WindowContext_t  TextWindowContext1   = {0,127,CURRENT_FONT_H*Line5,CURRENT_FONT_H*Line6,&CURRENT_FONT,GREEN,BLACK,RED}; 
...
HMI::Screen LivePowerScreen;
 ...
 static volatile uint32_t t1;
  ...
  void PowerMonitorInit()
  {
    ...
    //HomeScreen.Register(&SettingWindowRTC_time);
...
{ 
  ...
  rtc.GetDate((char*)&PowerText[CHARS_IN_LINE*Line1]);  
  PowerText[CHARS_IN_LINE*Line1 + 3] = ' ';  
  PowerText[CHARS_IN_LINE*Line1 + 9] = ' '; 
  intToStr(__LL_ADC_CALC_TEMPERATURE_TYP_PARAMS(4300,1400,25,3300,ChipTemperature.Read(),LL_ADC_RESOLUTION_12B), (char*)&PowerText[CHARS_IN_LINE*Line1 + 10], 1,' ');  
  PowerText[CHARS_IN_LINE*Line1 + 12] = '\'';
  PowerText[CHARS_IN_LINE*Line1 + 13] = 'c';
  
  rtc.GetTime((char*)&PowerText[CHARS_IN_LINE*Line2 +4]);
  PowerText[CHARS_IN_LINE*Line2 + 12] = ' ';
  
  V_Len = ftoa(Power.Voltage, (char*)&PowerText[CHARS_IN_LINE*Line4 + 4],2,' ');    
  
  I_Len = ftoa(Power.Current, (char*)&PowerText[CHARS_IN_LINE*Line5 + 4], 1,' '); 
...
{
  POWER_MONITOR_UART.SetBaudrate(UpdatedSettingValue);
}
