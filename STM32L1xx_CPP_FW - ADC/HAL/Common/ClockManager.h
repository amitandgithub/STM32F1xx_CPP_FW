...
{  
  ...
  public:
    ...
    typedef enum
    {
      ...
      CLOCK_GPIOA       = CLOCK_TYPE_AHB | 2,
      CLOCK_GPIOB       = CLOCK_TYPE_AHB | 3,
      CLOCK_GPIOC       = CLOCK_TYPE_AHB | 4,
      CLOCK_GPIOD       = CLOCK_TYPE_AHB | 5,
      CLOCK_GPIOE       = CLOCK_TYPE_AHB | 6,
      CLOCK_GPIOH       = CLOCK_TYPE_AHB | 6,
      CLOCK_GPIOF       = CLOCK_TYPE_AHB | 7,
      CLOCK_GPIOG       = CLOCK_TYPE_AHB | 8, 
