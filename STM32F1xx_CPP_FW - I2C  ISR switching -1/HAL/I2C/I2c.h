...
#define I2C_MASTER_INTR     1  // 1862 bytes - 1'706 - 1'698 - 1'694 - (1'906 master and slave) - 1'388
#define I2C_SLAVE_INTR      0  // 954 bytes - 812 - 924 - 758 - 754
#define I2C_MASTER_DMA      0  // 2'366 bytes - 2'236 - 2'260 - 2'200 - 1'936
#define I2C_SLAVE_DMA       0  // 1'710 bytes - 1'428 - 1'426 - 904 - 844
  
// Full I2C module - 4'562 - 4'468 - 3'432
...
//#define I2C_RX_METHOD_1  
  ...
  public:
    ...
    I2c(I2cPort_t I2cPort, Hz_t Hz = 100000U);
   ...
   // bool WaitOnFlag(volatile uint32_t* reg, uint32_t bitmask, uint32_t status, uint32_t timeout);
    ...
    void LoadRxDmaChannel(uint8_t* Buf, uint32_t len){dma1.Load(m_Curent_DMA_Rx_Channel, (uint32_t)&(I2C_DATA_REG(m_I2Cx)),(uint32_t)Buf,len, LL_DMA_DIRECTION_PERIPH_TO_MEMORY);}
    
    void LoadTxDmaChannel(uint8_t* Buf, uint32_t len){dma1.Load(m_Curent_DMA_Tx_Channel, (uint32_t)&(I2C_DATA_REG(m_I2Cx)),(uint32_t)Buf,len, LL_DMA_DIRECTION_MEMORY_TO_PERIPH);}
#endif
    ...
    class I2C1_DMA_Rx_Callback : public InterruptSource
    {
    public:
    ...
    class I2C1_DMA_Tx_Callback : public InterruptSource
    {
    public:
    ...
    class I2C2_DMA_Rx_Callback : public InterruptSource
    {
    public:
    ...
    class I2C2_DMA_Tx_Callback : public InterruptSource
    {
    public:
