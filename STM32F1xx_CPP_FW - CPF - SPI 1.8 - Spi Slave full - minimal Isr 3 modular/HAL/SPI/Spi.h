...
#define SPI_POLL                1  // 654
  
#define SPI_MASTER_Q            1  // 662

#define SPI_MASTER_INTR         1  // 1'704, 1'892 Q
#define SPI_SLAVE_INTR          1  // 2'812, 2'824Q
#define SPI_MASTER_DMA          1  // 1'968, 2'238Q
#define SPI_SLAVE_DMA           1  // 2'644, 2'676Q
  
// Full SPI module - 3'788
...
#endif //(SPI_MASTER_DMA == 1) || (SPI_SLAVE_DMA == 1)
