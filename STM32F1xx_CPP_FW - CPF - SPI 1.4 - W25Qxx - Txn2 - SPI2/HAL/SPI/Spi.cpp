...
//       // 13'047
//       *(uint32_t*)(&m_Transaction + 0) = *(uint32_t*)(pTransaction + 0);
//       *(uint32_t*)(&m_Transaction + 4) = *(uint32_t*)(pTransaction + 4);
//       *(uint32_t*)(&m_Transaction + 8) = *(uint32_t*)(pTransaction + 8);
//       *(uint32_t*)(&m_Transaction + 12) = *(uint32_t*)(pTransaction + 12);
    ...
    {
      _this->SPI1_DMA_Rx_Done_Handler();
    }
