...
#define RTC_BASE_YEAR 1970
  ...
  public:
    ...
    uint32_t ReadBackupReg(uint16_t reg){return LL_RTC_BKP_GetRegister(BKP,reg);}
    
    void WriteBackupReg(uint32_t reg,uint16_t Data){LL_RTC_BKP_SetRegister(BKP,reg,Data);}  
