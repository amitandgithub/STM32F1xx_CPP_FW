...
namespace HAL
{
  ...
  template< uint32_t Timerx, TimerChanel_t Chanel, uint32_t FirstEdge, uint32_t SecondEdge, uint32_t Samples, Callback* CB = nullptr >
    ...
    template< uint32_t Timerx, TimerChanel_t Chanel, uint32_t FirstEdge, uint32_t SecondEdge, uint32_t Samples, Callback* CB >
      Timer::TimerStatus_t PulseIn<Timerx,Chanel, FirstEdge,SecondEdge,Samples,CB>::HwInit(uint32_t Prescaler, uint32_t Autoreload, bool CountUp)
      {
    ...
    template< uint32_t Timerx, TimerChanel_t Chanel, uint32_t FirstEdge, uint32_t SecondEdge, uint32_t Samples, Callback* CB >
      void PulseIn<Timerx,Chanel, FirstEdge,SecondEdge,Samples,CB>::ISR()
      {      
