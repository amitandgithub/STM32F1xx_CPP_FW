...
namespace HAL
{
  ...
  template<uint32_t Timerx, TimerChanel_t Chanel,uint32_t Frequency = 10000>
    ...
    template<uint32_t Timerx, TimerChanel_t Chanel,uint32_t Frequency>
      Timer::TimerStatus_t PulseOut<Timerx,Chanel,Frequency>::HwInit()
      {
    ...
    template<uint32_t Timerx, TimerChanel_t Chanel,uint32_t Frequency>
      void PulseOut<Timerx,Chanel,Frequency>::ISR()
      {
        
      }
  
   template<uint32_t Timerx, TimerChanel_t Chanel,uint32_t Frequency>
      void PulseOut<Timerx,Chanel,Frequency>::SetDutyCycle(uint8_t dutycycle)
      {
  ...
  template<uint32_t Timerx, TimerChanel_t Chanel,uint32_t Frequency>
      void PulseOut<Timerx,Chanel,Frequency>::SetFrequency(uint32_t Freq)
      {
        LL_TIM_SetAutoReload((TIM_TypeDef*)Timerx,Freq);
      }
                                              
    template<uint32_t Timerx, TimerChanel_t Chanel,uint32_t Frequency>
      uint32_t PulseOut<Timerx,Chanel,Frequency>::GetCCRx()
      {
    ...
    template<uint32_t Timerx, TimerChanel_t Chanel,uint32_t Frequency>
      void PulseOut<Timerx,Chanel,Frequency>::SinglePulseOut(uint8_t dutycycle, uint32_t Freq, uint32_t Count)       
      {
    ...
    template<uint32_t Timerx, TimerChanel_t Chanel,uint32_t Frequency>
      void PulseOut<Timerx,Chanel,Frequency>::SinglePulseOutDisable()       
      {
        Timer::DisableTimerCounter<Timerx>();
