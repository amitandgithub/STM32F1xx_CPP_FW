...
namespace HAL
{
  ...
  Spi::Spi(SpiPort_t SpiPort, Hz_t Hz) :
    ...
    {      
      ...
      if(m_Transaction.Mode == SPI_8BIT)
      {
        LL_DMA_SetPeriphSize(dma1.m_DMAx, m_Curent_DMA_Tx_Channel, LL_DMA_PDATAALIGN_BYTE);
      }
      else
      {
        LL_DMA_SetPeriphSize(dma1.m_DMAx, m_Curent_DMA_Tx_Channel, LL_DMA_PDATAALIGN_HALFWORD); 
      }       
    ...
    {      
      ...
      if(m_Transaction.Mode == SPI_8BIT)
      {
        LL_DMA_SetPeriphSize(dma1.m_DMAx, m_Curent_DMA_Rx_Channel, LL_DMA_PDATAALIGN_BYTE); 
        LL_DMA_SetPeriphSize(dma1.m_DMAx, m_Curent_DMA_Tx_Channel, LL_DMA_PDATAALIGN_BYTE); 
      }
      else
      {
        LL_DMA_SetPeriphSize(dma1.m_DMAx, m_Curent_DMA_Rx_Channel, LL_DMA_PDATAALIGN_HALFWORD); 
        LL_DMA_SetPeriphSize(dma1.m_DMAx, m_Curent_DMA_Tx_Channel, LL_DMA_PDATAALIGN_HALFWORD); 
      }
