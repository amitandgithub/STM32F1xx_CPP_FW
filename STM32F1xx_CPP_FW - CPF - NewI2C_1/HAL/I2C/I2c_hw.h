...
#define I2C_ENABLE_INT_BUF(_I2C_)       SET_BIT(_I2C_->CR2, I2C_CR2_ITEVTEN)

#define I2C_DISABLE_INT_BUF(_I2C_)      CLEAR_BIT(_I2C_->CR2, I2C_CR2_ITEVTEN)
...
#define WAIT_FOR_STOP_FLAG_TO_CLEAR(_I2C_,TIMEOUT) WaitOnFlag(&_I2C_->SR1, I2C_SR1_STOPF, I2C_SR1_STOPF, TIMEOUT)
