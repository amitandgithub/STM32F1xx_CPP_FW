...
{ 
  ...
  */
  RTC_InitStruct.AsynchPrescaler = 0x00007FFFU;//0xFFFFFFFFU;
...
//    
  ...
  Rtc::RTCStatus_t Rtc::SetTime(RtcTime_t* aRtcTime)
  {
    ...
    status =   LL_RTC_TIME_Init(RTC, LL_RTC_FORMAT_BIN, aRtcTime);
  ...
  Rtc::RTCStatus_t Rtc::SetTime(uint8_t Hours, uint8_t Minutes, uint8_t Seconds)
  {
    ...
    RtcTime_t RtcTime = {Hours,Minutes,Seconds};
    
    status =   LL_RTC_TIME_Init(RTC, LL_RTC_FORMAT_BIN, &RtcTime);
  ...
  */
  ...
  Rtc::RTCStatus_t Rtc::SetAlarm(RtcTime_t* AlarmTime)
  {
  ...
  Rtc::RTCStatus_t Rtc::SetAlarm(uint8_t Hours, uint8_t Minutes, uint8_t Seconds)
  {
    uint32_t counter_alarm = 0U, counter_time;
