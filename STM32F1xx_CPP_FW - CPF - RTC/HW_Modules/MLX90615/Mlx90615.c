...
void	Mlx90615_ReadConfig(void)
{
    ...
    i2c1.XferPoll(_MLX90615_I2C_ADDRESS,Add,1,Data,2,1);
...
bool	Mlx90615_Init(void)
{
  i2c1.HwInit();
	...
	//if(HAL_I2C_IsDeviceReady(&_MLX90615_I2C,_MLX90615_I2C_ADDRESS,1,20)!=HAL_OK)
		//return false;
    //while(i2c1.Ping(_MLX90615_I2C_ADDRESS) != true);
	Mlx90615_ReadConfig();	
	return true;
}
uint8_t crc;
...
{	
  uint8_t	Add[2];
	...
	//if(I2C_Mem_Read(&_MLX90615_I2C,_MLX90615_I2C_ADDRESS,0x27,I2C_MEMADD_SIZE_8BIT,Data,3,100)!=HAL_OK)
     ...
     Add[0] = 0x27;
     i2c1.XferPoll(_MLX90615_I2C_ADDRESS,Add,1,Data,3,1);
...
void	Mlx90615_EnterSleep(void)
{
    ...
    i2c1.XferPoll(_MLX90615_I2C_ADDRESS,Data,2);
...
bool	_Mlx90615_SetEmissivity(uint16_t	Emissivity)
{
	...
	*data = crc8Msb(0x07, (uint8_t*)buffer, 4);
	...
	//	return false;
     ...
     Add[0] = 0x13;
     i2c1.XferPoll(_MLX90615_I2C_ADDRESS,Add,1); // Write mem Address
     i2c1.XferPoll(_MLX90615_I2C_ADDRESS,&buffer[2],3); // Write mem Data
	...
	//I2C_Mem_Read(&_MLX90615_I2C,_MLX90615_I2C_ADDRESS,0x13,I2C_MEMADD_SIZE_8BIT,buffer,2,100);
     ...
     Add[0] = 0x13;
     i2c1.XferPoll(_MLX90615_I2C_ADDRESS,Add,1,buffer,2,1);
