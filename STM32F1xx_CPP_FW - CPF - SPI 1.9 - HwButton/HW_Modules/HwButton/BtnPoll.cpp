...
namespace BSP
{
  ...
  BtnPoll::BtnPoll(Port_t Port, PIN_t Pin,Mode_t Mode,IntEdge_t Edge, Callback_t OnRise, Callback_t OnFall) :
    m_BtnPin(Port,Pin,Mode,Edge),
    m_debounce(0),
    ...
    BtnPoll::Status_t BtnPoll::HwInit()
    {
