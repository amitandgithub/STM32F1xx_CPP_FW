...
//        m_Transaction.Spi_Baudrate = SPI_BAUDRATE_DIV2;
    ...
    {     
      ...
      else if(m_SPIx == nullptr)
      {
        ...
        AFIO->MAPR |= 1; // Remap (NSS/PA15, SCK/PB3, MISO/PB4, MOSI/PB5)
      }
      else
      {
        while(1);
      ...
      {   
        GpioOutput      sck(ClkPort,ClkPin,OUTPUT_AF_PUSH_PULL);
        GpioInput       miso(MisoPort,MisoPin,INPUT_PULLUP);
        GpioOutput      mosi(MosiPort,MosiPin,OUTPUT_AF_PUSH_PULL);
      ...
      {        
        GpioInput       ChipSelect(ChipSelectPort,ChipSelectPin,INPUT_PULLDOWN);
        GpioInput       sck(ClkPort,ClkPin,INPUT_PULLDOWN);
        GpioOutput      miso(MisoPort,MisoPin,OUTPUT_AF_PUSH_PULL);
        GpioInput       mosi(MosiPort,MosiPin,INPUT_PULLDOWN);
    ...
    void Spi::SPI1_DMA_MasterTx_Done_Handler()
    {		
    ...
    void Spi::SPI2_DMA_MasterTx_Done_Handler()
    {		
      /* Transfer Complete Interrupt management ***********************************/
    ...
    void Spi::SPI1_DMA_SlaveRx_Done_Handler()
    {		
      /* Transfer Complete Interrupt management ***********************************/
    ...
    void Spi::SPI1_DMA_SlaveTx_Done_Handler()
    {		
      /* Transfer Complete Interrupt management ***********************************/
      if (LL_DMA_IsActiveFlag_TC3(dma1.m_DMAx))
      {        
    ...
    void Spi::SPI2_DMA_SlaveRx_Done_Handler()
    {		
      /* Transfer Complete Interrupt management ***********************************/
    ...
    void Spi::SPI2_DMA_SlaveTx_Done_Handler()
    {		
      /* Transfer Complete Interrupt management ***********************************/
      if (LL_DMA_IsActiveFlag_TC5(dma1.m_DMAx))
      {        
    ...
    void Spi::SPI1_DMA_Rx_Callback::ISR( )
    {
      _this->SPI1_DMA_SlaveRx_Done_Handler(); 
    } 
    
    void Spi::SPI2_DMA_Rx_Callback::ISR( )
    {
