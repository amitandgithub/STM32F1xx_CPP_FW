...
#define I2C_RX_METHOD_1 
  ...
  public:
    ...
    I2CStatus_t     XferIntr(uint16_t SlaveAddress,uint8_t* TxBuf, uint32_t TxLen, uint8_t* RxBuf=nullptr, uint32_t RxLen=0,uint8_t RepeatedStart=0, I2CCallback_t XferDoneCallback = nullptr);
