...
namespace HMI
{
  ...
  public:
    ...
    Window(const WindowContext_t* pWindowContext): m_pWindowContext(pWindowContext),m_bgcolor(BLACK)
    {
      
    }
      
    virtual bool Run(InputEvents_t InputEvents) = 0;
