...
void Display_I_and_V(uint8_t font)
{
  static uint8_t TimeString[]  = "00:00 12.00v";
  ...
  TimeString[5] = ' ';
  ftoa(Power.Voltage, (char*)&TimeString[6], 2);
  SSD1306_GotoXY (0,0);
  ...
  ftoa(Power.mAH, (char*)&I2C_mAH[2], 2);  
  SSD1306_GotoXY (0,font*2);
  SSD1306_Puts((char*)I2C_mAH, &FONT, SSD1306_COLOR_WHITE);
...
void Dispay_RTC()
{
  ...
  while(1)
  {
    ...
    rtc.GetDate(&TimeString[9]);

    TimeString[8] = 0;
      
    SSD1306_GotoXY (0,0);
    SSD1306_Puts( (char*)&TimeString[9], &FONT, SSD1306_COLOR_WHITE);//Font_11x18 
