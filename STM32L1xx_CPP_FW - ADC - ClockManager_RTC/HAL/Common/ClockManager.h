...
{  
  ...
  public:
    ...
    typedef enum
    {
      ...
      CLOCK_GPIOA       = CLOCK_TYPE_AHB | 0,
      CLOCK_GPIOB       = CLOCK_TYPE_AHB | 1,
      CLOCK_GPIOC       = CLOCK_TYPE_AHB | 2,
      CLOCK_GPIOD       = CLOCK_TYPE_AHB | 3,
      CLOCK_GPIOE       = CLOCK_TYPE_AHB | 4,
      CLOCK_GPIOH       = CLOCK_TYPE_AHB | 5,
      CLOCK_GPIOF       = CLOCK_TYPE_AHB | 6,
      CLOCK_GPIOG       = CLOCK_TYPE_AHB | 7, 
      CLOCK_CRC         = CLOCK_TYPE_AHB | 12,
      CLOCK_FLITF       = CLOCK_TYPE_AHB | 15,
      CLOCK_SRAM        = CLOCK_TYPE_AHB | 16,   
      CLOCK_DMA1        = CLOCK_TYPE_AHB | 24,
      CLOCK_DMA2        = CLOCK_TYPE_AHB | 25,
      CLOCK_AES         = CLOCK_TYPE_AHB | 27,
      CLOCK_FSM         = CLOCK_TYPE_AHB | 30,      
      ...
      CLOCK_COMP        = CLOCK_TYPE_APB1 | 31,      
      
      /* APB2 peripherals*/
      CLOCK_TYPE_APB2   = 0x20000000UL,
      CLOCK_SYSCFG      = CLOCK_TYPE_APB2 | 0,
      CLOCK_TIM9        = CLOCK_TYPE_APB2 | 2,
      CLOCK_TIM10       = CLOCK_TYPE_APB2 | 3,
      CLOCK_TIM11       = CLOCK_TYPE_APB2 | 4,        
      CLOCK_ADC1        = CLOCK_TYPE_APB2 | 9,
      CLOCK_SDIO        = CLOCK_TYPE_APB2 | 11,
    ...
    static bool SetSystemClock(SystemClock_t SystemClock, uint32_t Divider, uint32_t Multiplier)
    {
      if(SystemClock == CLOCK_HSE)
      {
        ...
        LL_RCC_PLL_ConfigDomain_SYS(LL_RCC_PLLSOURCE_HSE,Divider, Multiplier);
        //return true;
      }
      else  if(SystemClock == CLOCK_HSI)
      {
        ...
        LL_RCC_PLL_ConfigDomain_SYS(LL_RCC_PLLSOURCE_HSI,Divider, Multiplier);
        //return true;
      }
      else
      {
