...
{   
  if((GPIO_TypeDef*)_GPIOx == GPIOA )
  {
    LL_APB1_GRP1_DisableClock(LL_AHB1_GRP1_PERIPH_GPIOA);
  }
  else  if((GPIO_TypeDef*)_GPIOx == GPIOB )
  {
    LL_APB1_GRP1_DisableClock(LL_AHB1_GRP1_PERIPH_GPIOB);
  }
  else  if((GPIO_TypeDef*)_GPIOx == GPIOB )
  {
    LL_APB1_GRP1_DisableClock(LL_AHB1_GRP1_PERIPH_GPIOC);
  }
  else  if((GPIO_TypeDef*)_GPIOx == GPIOD )
  {
    LL_APB1_GRP1_DisableClock(LL_AHB1_GRP1_PERIPH_GPIOD);
  }
#if defined(GPIOE)
  else  if((GPIO_TypeDef*)_GPIOx == GPIOE )
  {
    LL_APB1_GRP1_DisableClock(LL_AHB1_GRP1_PERIPH_GPIOE);
  }
#endif
#if defined(GPIOF)
  else  if((GPIO_TypeDef*)_GPIOx == GPIOF )
  {
    LL_APB1_GRP1_DisableClock(LL_APB2_GRP1_PERIPH_GPIOG);
  }
#endif
