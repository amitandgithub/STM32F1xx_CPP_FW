...
#define SPI_LOG_STATES_SIZE 500
  ...
  public:
    ...
    void SetMode(uint8_t mode){ m_SPIx->CR1 &= 0xFFFCU; m_SPIx->CR1 |= mode&3; } // Shd not call when Comm is ongoing, register SPI_CR1 CPHA: bit 0, CPOL: bit 1
    ...
    class SPI_DMA_Tx_Callback : public InterruptSource
    {
    public:
      SPI_DMA_Tx_Callback(Spi* This):_this(This){};
      virtual void ISR() ;
    private:
      Spi* _this;
    };

    class SPI_DMA_Rx_Callback : public InterruptSource
    {
    public:
      SPI_DMA_Rx_Callback(Spi* This):_this(This){};
      virtual void ISR() ;
    private:
      Spi* _this;
    };      
    
    void SPI_DMA_MasterTx_Done_Handler();
    
    void SlaveHwInit(XferMode_t mode = SPI_8BIT);
    
    void SPI_DMA_SlaveTx_Done_Handler();
    
    void SPI_DMA_SlaveRx_Done_Handler();
  ...
  private:   
    ...
    SPI_DMA_Tx_Callback m_SPI_DMA_Tx_Callback;
    SPI_DMA_Rx_Callback m_SPI_DMA_Rx_Callback;
#endif
