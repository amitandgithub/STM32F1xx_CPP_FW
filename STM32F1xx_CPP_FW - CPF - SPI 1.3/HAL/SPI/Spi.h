...
#define SPI_LOG_STATES_SIZE 500
  ...
  public:
    ...
    SpiStatus_t     TxIntr(uint8_t* TxBuf, uint32_t TxLen, SPI_Xfer_Mode_t SPI_Xfer_Mode = SPI_XFER_MODE_DEFAULT, SPICallback_t XferDoneCallback = nullptr);
    
    SpiStatus_t     RxIntr(uint8_t* RxBuf, uint32_t RxLen, SPI_Xfer_Mode_t SPI_Xfer_Mode = SPI_XFER_MODE_DEFAULT, SPICallback_t XferDoneCallback = nullptr);
