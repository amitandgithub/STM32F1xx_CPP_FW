...
#if I2C_MASTER_INTR || I2C_SLAVE_INTR
#include "I2c_Intr.h"
#endif
...
#endif //(I2C_MASTER_INTR == 1) && (I2C_SLAVE_INTR == 0)
...
#else
    #error "Invaild I2C Configuration"
#endif
...
#endif  // (I2C_MASTER_INTR == 1) || (I2C_SLAVE_INTR == 1) || (I2C_MASTER_DMA == 1) || (I2C_SLAVE_DMA == 1)
    
    
#if 0 //(I2C_MASTER_DMA == 1) || (I2C_SLAVE_DMA == 1)
