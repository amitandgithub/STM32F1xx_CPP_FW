...
namespace BSP 
{
    ...
    public:
      ...
      ST7735(ST7735_t ST7735t, HAL::Spi* pSpiDriverLCD, Port_t CSPort, PIN_t CSPin,Port_t DCPort, PIN_t DCPin, Port_t RstPort, PIN_t RstPin, Port_t BklPort, PIN_t BklPin);
      void HwInit();
