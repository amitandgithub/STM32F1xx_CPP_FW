...
//    }SlaveTxn_t; 
    ...
    SpiStatus_t     TxIntr(uint8_t* TxBuf, uint32_t TxLen, XferMode_t mode = SPI_8BIT, Spi_Baudrate_t Spi_Baudrate = SPI_BAUDRATE_DIV4, SPICallback_t XferDoneCallback = nullptr, Port_t CSPort = (Port_t)0, uint16_t CSPinmask = 0);
    
    SpiStatus_t     RxIntr(uint8_t* RxBuf, uint32_t RxLen,  XferMode_t mode = SPI_8BIT,Spi_Baudrate_t Spi_Baudrate = SPI_BAUDRATE_DIV4, SPICallback_t XferDoneCallback = nullptr, Port_t CSPort = (Port_t)0, uint16_t CSPinmask = 0);
    ...
    SpiStatus_t     RxDMA(uint8_t* RxBuf, uint32_t RxLen, XferMode_t mode = SPI_8BIT,Spi_Baudrate_t Spi_Baudrate = SPI_BAUDRATE_DIV4, SPICallback_t XferDoneCallback = nullptr, Port_t CSPort = (Port_t)0, uint16_t CSPinmask = 0);
    
    SpiStatus_t     TxDMA(uint8_t* TxBuf, uint32_t TxLen, XferMode_t mode = SPI_8BIT,Spi_Baudrate_t Spi_Baudrate = SPI_BAUDRATE_DIV4, SPICallback_t XferDoneCallback = nullptr, Port_t CSPort = (Port_t)0, uint16_t CSPinmask = 0);
    
    SpiStatus_t     TxRxDMA(Transaction_t const * pTransaction);
    
    SpiStatus_t     XferDMA(Transaction_t const * pTransaction);
    
    SpiStatus_t SlaveHwInit(SlaveTxn_t* SlaveTxn,  uint32_t mode = 0);
    
    void SrartListening(SPIState_t SPIState);
    ...
    SpiStatus_t CheckAndLoadTxn(uint8_t* TxBuf, uint32_t TxLen,uint8_t* RxBuf, uint32_t RxLen, XferMode_t mode,Spi_Baudrate_t Spi_Baudrate, SPICallback_t XferDoneCallback,Port_t CSPort, uint16_t CSPinmask);
