...
typedef struct
{
	uint8_t		SMBus_Mode:1;
	uint8_t		PWM_FreqLow:1;
	uint8_t		PWM_Target:1;
	uint16_t	Factory_Calib:9;
	uint8_t		IIR_Setting:3;
...
bool	Mlx90615_SetEmissivity(float	Emissivity_0_to_1_Float);
