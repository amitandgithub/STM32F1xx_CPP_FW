...
namespace HAL
{
  ...
  {   
...
#if UART_DMA 
      dma1.HwInit();
      InterruptManagerInstance.RegisterDeviceInterrupt(DMA1_Channel6_IRQn,0,&m_UART_DMA_Tx_Callback);
    ...
    else if(m_UARTx == USART3)
    {
      ...
      InterruptManagerInstance.RegisterDeviceInterrupt(DMA1_Channel3_IRQn,0,&m_UART_DMA_Tx_Callback);
