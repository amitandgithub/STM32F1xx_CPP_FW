...
#if I2C_MASTER_DMA   
        dma1.HwInit();
        InterruptManagerInstance.RegisterDeviceInterrupt(DMA1_Channel7_IRQn,0,&m_SPI_DMA_Rx_Callback);
        InterruptManagerInstance.RegisterDeviceInterrupt(DMA1_Channel6_IRQn,0,&m_SPI_DMA_Tx_Callback);
...
#endif
#if (I2C_MASTER_DMA == 1) 
        InterruptManagerInstance.RegisterDeviceInterrupt(DMA1_Channel5_IRQn,0,&m_SPI_DMA_Rx_Callback);
        InterruptManagerInstance.RegisterDeviceInterrupt(DMA1_Channel4_IRQn,0,&m_SPI_DMA_Tx_Callback);
...
/************************I2C polling Functions END ************************/
    
    
/************************I2C Master Interrupt Functions Start ************************/
#if I2C_MASTER_INTR
...
/************************I2C Master Interrupt Functions End ************************/
    
    
/************************I2C Slave Interrupt Functions Start ************************/
...
/************************I2C Slave Interrupt Functions End ************************/
    
    
    
/************************I2C Master DMA Functions Start ************************/
#if (I2C_MASTER_DMA == 1) 
...
/************************I2C Master DMA Functions End ************************/
    
    
    
/************************I2C Slave DMA Functions Start ************************/   
#if I2C_SLAVE_DMA   
