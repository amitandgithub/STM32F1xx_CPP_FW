...
Sign in
Sign up
45 153 171 adafruit/Adafruit_BME280_Library
 Code  Issues 3  Pull requests 3  Projects 0  Security  Insights
Join GitHub today
GitHub is home to over 36 million developers working together to host and review code, manage projects, and build software together.

Adafruit_BME280_Library/Adafruit_BME280.cpp
@hoffmannjan hoffmannjan added spi fixes
7e39c44 14 days ago
@ladyada @hoffmannjan @mozzbozz @frankleonrose @deanm1278 @pm73 @microbuilder @tdicola @sellensr @kankaristo @moikorg
561 lines (491 sloc)  16.9 KB
