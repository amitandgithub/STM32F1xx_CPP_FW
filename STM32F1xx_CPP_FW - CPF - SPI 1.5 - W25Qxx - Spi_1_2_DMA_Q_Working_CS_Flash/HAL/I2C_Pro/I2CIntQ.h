...
#define _DMA DMA::GetInstance(1)
    ...
    {
    public:
        I2C1_DMA_Rx_Callback(I2CInt* This):m_This(This){};
    ...
    {
    public:
        I2C1_DMA_Tx_Callback(I2CInt* This):m_This(This){};
        virtual void CallbackFunction();
    private:
        I2CInt* m_This;
    };
    ...
    {
    public:
        I2C2_DMA_Rx_Callback(I2CInt* This):m_This(This){};
        virtual void CallbackFunction();
    private:
        I2CInt* m_This;
    };
    ...
    {
    public:
        I2C2_DMA_Tx_Callback(I2CInt* This):m_This(This){};
        virtual void CallbackFunction();
    private:
        I2CInt* m_This;
    };
