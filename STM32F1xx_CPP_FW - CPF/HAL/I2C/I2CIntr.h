...
#define I2C_LOG_STATES(log)
    ...
    public:
        ...
        I2CStatus_t MasterTx(uint16_t SlaveAddress,uint8_t* TxBuf, uint32_t TxLen, I2CCallback_t XferDoneCallback = nullptr);
        
        I2CStatus_t MasterTx(Transaction_t* pTransaction);
        
        I2CStatus_t MasterRx(uint16_t SlaveAddress,uint8_t* RxBuf, uint32_t RxLen, I2CCallback_t XferDoneCallback = nullptr );
