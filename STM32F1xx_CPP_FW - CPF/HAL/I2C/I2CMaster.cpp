...
namespace HAL
{
    ...
    I2CMaster::I2CMaster(Pin_t scl, Pin_t sda, Hz_t Hz) :
        ...
        I2CMaster::I2CStatus_t I2CMaster:: Send(uint16_t SlaveAddress,uint8_t* pdata, uint32_t len, uint32_t* pbytesXfered)
        {
        ...
        I2CMaster::I2CStatus_t I2CMaster:: Read(uint16_t SlaveAddress,uint8_t* pdata, uint32_t len, uint32_t* pbytesXfered )
        {
            uint32_t XferSize, Received_data = 0;
