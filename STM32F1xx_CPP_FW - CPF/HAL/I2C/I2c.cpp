...
#pragma inline = forced
    ...
    {			      
      ...
      if (LL_DMA_IsActiveFlag_TC6(DMA1Instance.m_DMAx))
      {
        /* Disable the half transfer interrupt if the DMA mode is not CIRCULAR */
        if(LL_DMA_GetMode(DMA1Instance.m_DMAx,I2C1_TX_DMA_CHANNEL) == LL_DMA_MODE_CIRCULAR)
        {
        ...
        LL_DMA_ClearFlag_TC6(DMA1Instance.m_DMAx);
        
        /* Clear the half transfer complete flag */
        LL_DMA_ClearFlag_HT6(DMA1Instance.m_DMAx);                 
      ...
      else if (LL_DMA_IsActiveFlag_HT6(DMA1Instance.m_DMAx))
      {
      ...
      else if ( LL_DMA_IsActiveFlag_TE6(DMA1Instance.m_DMAx))
      {
        ...
        /* Clear all flags */
        //DMA1Instance.m_DMAx->IFCR = (DMA_ISR_GIF1 << hdma->ChannelIndex);
    ...
    {			    
      /* Transfer Complete Interrupt management ***********************************/
      if (LL_DMA_IsActiveFlag_TC7(DMA1Instance.m_DMAx))
      {
        /* Disable the half transfer interrupt if the DMA mode is not CIRCULAR */
        if(LL_DMA_GetMode(DMA1Instance.m_DMAx,I2C1_RX_DMA_CHANNEL) == LL_DMA_MODE_CIRCULAR)
        {
          /* Disable all the DMA interrupt */
        ...
        LL_DMA_ClearFlag_TC7(DMA1Instance.m_DMAx);
        
        /* Clear the half transfer complete flag */
        LL_DMA_ClearFlag_HT7(DMA1Instance.m_DMAx);  
      ...
      /* Half Transfer Complete Interrupt management ******************************/
      else if (LL_DMA_IsActiveFlag_HT7(DMA1Instance.m_DMAx))
      {
      ...
      /* Transfer Error Interrupt management **************************************/
      else if ( LL_DMA_IsActiveFlag_TE7(DMA1Instance.m_DMAx))
      {
        /* When a DMA transfer error occurs */
        /* A hardware clear of its EN bits is performed */
        /* Disable ALL DMA IT */
