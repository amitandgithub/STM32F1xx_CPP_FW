...
//                }
        ...
        void I2c::Master_Rx_BTF_Handler()
        {
...
//                return;
        ...
        void I2c::Master_Tx_BTF_Handler()
        {
		...
		{			      
            ...
            if (LL_DMA_IsActiveFlag_TC6(_DMA->_DMAx))
            {
                ...
                if(LL_DMA_GetMode(_DMA->_DMAx,I2C1_TX_DMA_CHANNEL) == LL_DMA_MODE_CIRCULAR)
                {
                    ...
                    _DMA->DisableHalfTransferCompleteInterrupt(I2c::I2C1_TX_DMA_CHANNEL);
                    _DMA->DisableTransferCompleteInterrupt(I2c::I2C1_TX_DMA_CHANNEL);
                    _DMA->DisableTransferErrorInterrupt(I2c::I2C1_TX_DMA_CHANNEL);
                }                 
