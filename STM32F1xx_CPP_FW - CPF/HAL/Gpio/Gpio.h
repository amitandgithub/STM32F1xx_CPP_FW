...
namespace HAL
{
    ...
    public:
        ...
        constexpr Port_t  getPort(const Pin_t  pin);
    ...
    /*
      4 667 bytes of readonly  code memory
        354 bytes of readonly  data memory
      2 626 bytes of readwrite data memory
        this function is totally eliminated
    */
...
//    }
    ...
    /*
  4 639 bytes of readonly  code memory
    354 bytes of readonly  data memory
  2 626 bytes of readwrite data memory
    */
    constexpr Gpio::Port_t Gpio::getPort(const Pin_t  pin)
    {
        constexpr GPIO_TypeDef * GPIOArray[9] = {GPIOA,GPIOB,GPIOC,GPIOD
